...
fn test_full_lifecycle_with_hibernation() {
    ...
    client
        .enter_hibernation(&vault_id, &owner, &hibernation)
        .unwrap();
...
fn test_partial_liquidate_preserves_ttl() {
    ...
    client
        .partial_liquidate(&vault_id, &5_000i128, &1u32)
        .unwrap();
...
fn test_partial_liquidate_then_check_in_resets_ttl() {
    ...
    client
        .partial_liquidate(&vault_id, &50_000i128, &5u32)
        .unwrap();
